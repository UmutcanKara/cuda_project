...
void dijkstra_serial(int V, int *adjacency_matrix, int *len, int *temp_distance)
{
    ...
    printf("TOTAL TIME FOR DIJKSTRA ALL PAIRS SEARCH ON CPU = %f SECS\n", seconds);

    free(visited);
}

void dijkstra_serial_single_source(int V, int *adjacency_matrix, int *len, int *temp_distance)
{
    boolean *visited = (boolean *)malloc(V * sizeof(boolean));
    ...
    clock_t end = clock();
    float seconds = (float)(end - start) / CLOCKS_PER_SEC;
    printf("TOTAL TIME FOR DIJKSTRA SINGLE SOURCE SEARCH ON CPU = %f SECS\n", seconds);
...
int main(int argc, char **argv)
{
    ...
    clock_t end = clock();
    float seconds = (float)(end - start) / CLOCKS_PER_SEC;
    printf("TIME TO CREATE GRAPH ON CPU = %f SECS\n", seconds);
    dijkstra_serial_single_source(V, adjacency_matrix, len, temp_distance);
